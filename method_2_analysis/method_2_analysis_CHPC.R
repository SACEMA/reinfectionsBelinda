...
for (a in splseq){
  ...
  exportDoMPI(cl, c('disease_params','lprior','llikePrior', 'logParms', 'unlogParms'
                    ,'initBounds','mcmcSampler','initRand','default.proposer','mcmcParams',
                    'doChains', 'do.mcmc', 'expected', 'nllikelihood'))
  registerDoMPI(cl)
