...
#get parameters.r from the file
...
sims <- featurizer::par_sapply(rep(1:mcmc$n_posterior, n_sims_per_param), sim_reinf)
...
saveRDS(results, file=paste0("raw_output/m2/results_", i,".RDS"))
