...
proportion_m3 <- proportion_m3 +  guides(fill = "none")
proportion_m4 <- proportion_m4 + guides(fill = "none")
proportion_m5 <- proportion_1_5_0.4_0.5 
...
#Proportion plot for S5
proportion_1_2_0.1_0.2 <- proportion_1_2_0.1_0.2 + guides(fill = "none")
proportion_1_0.1_0.2 <- proportion_1_0.1_0.2 + guides(fill = "none")

top_1 <- grid.arrange(nrow=1
                      , arrangeGrob(proportion_1_0.1_0.2
                                    , top = grid::textGrob(expression(sigma=1), x = 0, hjust = 0))
                      , arrangeGrob(proportion_1_2_0.1_0.2
                                    , top = grid::textGrob(expression(sigma=1.2), x = 0, hjust = 0))
                      , arrangeGrob(proportion_1_5_0.1_0.2
                                    , top = grid::textGrob(expression(sigma=1.5), x = 0, hjust = 0))
                      
                      , widths=c(0.92, 0.92, 1.18)
)
proportion_1_0.2_0.3  <- proportion_1_0.2_0.3 + guides(fill = "none")
proportion_1_2_0.2_0.3 <- proportion_1_2_0.2_0.3 + guides(fill = "none")
proportion_1_5_0.2_0.3 <- proportion_1_5_0.2_0.3 + guides(fill = "none")

top_2 <- grid.arrange(nrow=1
                      , arrangeGrob(proportion_1_0.2_0.3
                                    , top = grid::textGrob(expression(sigma=1), x = 0, hjust = 0))
                      , arrangeGrob(proportion_1_2_0.2_0.3
                                    , top = grid::textGrob(expression(sigma=1.2), x = 0, hjust = 0))
                      , arrangeGrob(proportion_1_5_0.2_0.3
                                    , top = grid::textGrob(expression(sigma=1.5), x = 0, hjust = 0))
                      
)
proportion_1_0.3_0.4  <- proportion_1_0.3_0.4 + guides(fill = "none")
proportion_1_2_0.3_0.4<- proportion_1_2_0.3_0.4 + guides(fill = "none")
proportion_1_5_0.3_0.4 <- proportion_1_5_0.3_0.4 + guides(fill = "none")

top_3 <- grid.arrange(nrow=1
                      , arrangeGrob(proportion_1_0.3_0.4
                                    , top = grid::textGrob(expression(sigma=1), x = 0, hjust = 0))
                      , arrangeGrob(proportion_1_2_0.3_0.4
                                    , top = grid::textGrob(expression(sigma=1.2), x = 0, hjust = 0))
                      , arrangeGrob(proportion_1_5_0.3_0.4
                                    , top = grid::textGrob(expression(sigma=1.5), x = 0, hjust = 0))
                      
)

proportion_1.5 <- grid.arrange(nrow=3
...
ggsave(proportion_1.5, file='sbv/plots/proportion_1.5.png', width = 796/72, height=796/72, type='cairo')
